 ...
 *
 * It is possible to connect to a redis server using [[host]] and [[port]] or using a [[unixSocket]].
 *
...
class MyRedis
{
     ...
     * If [[unixSocket]] is specified, host and [[port]] will be ignored.
     */
     ...
     * This can be used instead of [[host]] and [[port]] to connect to the server using a unix socket.
     * If a unix socket path is specified, [[host]] and [[port]] will be ignored.
     * @since 2.0.1
     */
    public $unixSocket;
    /**
